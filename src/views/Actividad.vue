  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Elementos que hacen parte de una propuesta de innovación
        p.mb-4 Identificar los elementos que hacen parte de una propuesta de innovación empresarial, para generar competitividad.
